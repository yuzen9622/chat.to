...
export default function ListItem({
  ...
  return (
    <Link
      className={twMerge(
        " relative flex items-center sm:justify-start justify-center w-11/12 p-2 m-1 text-lg hover:bg-stone-900/5 hover:dark:bg-white/5 transition-colors  dark:text-white rounded-lg",
        className,
